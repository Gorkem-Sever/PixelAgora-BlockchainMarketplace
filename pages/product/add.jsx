    ...
    <div className="h-screen flex justify-center mx-auto bg-gray-100 dark:bg-gray-900 text-black dark:text-white">
      <div className="w-11/12 md:w-2/5 h-7/12 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="flex flex-row justify-between items-center border border-gray-300 dark:border-gray-600 p-2 rounded-xl mt-5">
            ...
            {links.length !== 5 && (
              <button
                onClick={addImage}
                type="button"
                className="p-2 bg-orange-500 text-white rounded-full text-sm"
              >
                Add image link
              </button>
            )}
          ...
          <button
            type="submit"
            className={`flex flex-row justify-center items-center w-full text-white text-md bg-orange-500 py-2 px-5 rounded-full drop-shadow-xl hover:bg-white border-transparent border hover:text-orange-500 hover:border-orange-500 mt-5 transition-all duration-500 ease-in-out ${
